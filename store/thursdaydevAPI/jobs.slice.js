...
export const api_v1_job_list = createAsyncThunk(
  "jobs/api_v1_job_list",
  async payload => {
    const response = await apiService.api_v1_job_list(payload)
    return response.data
  }
)
export const api_v1_job_create = createAsyncThunk(
  "jobs/api_v1_job_create",
  async payload => {
    const response = await apiService.api_v1_job_create(payload)
    return response.data
  }
)
export const api_v1_job_retrieve = createAsyncThunk(
  "jobs/api_v1_job_retrieve",
  async payload => {
    const response = await apiService.api_v1_job_retrieve(payload)
    return response.data
  }
)
export const api_v1_job_update = createAsyncThunk(
  "jobs/api_v1_job_update",
  async payload => {
    const response = await apiService.api_v1_job_update(payload)
    return response.data
  }
)
export const api_v1_job_partial_update = createAsyncThunk(
  "jobs/api_v1_job_partial_update",
  async payload => {
    const response = await apiService.api_v1_job_partial_update(payload)
    return response.data
  }
)
export const api_v1_job_destroy = createAsyncThunk(
  "jobs/api_v1_job_destroy",
  async payload => {
